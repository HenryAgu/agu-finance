  ...
  return (
    <main className="bg-home-background-image bg-no-repeat bg-center bg-cover h-screen w-full">
      <div className="p-6 flex items-center justify-between">
        ...
        <div>
          <button className="bg-primaryButton px-12 py-2 font-medium rounded-md shadow-sm lg:text-base">
            Login
          </button>
        </div>
      </div>
      <div className="flex flex-col gap-y-10 justify-center items-center mt-40">
        ...
        <button className="bg-secondaryButton px-16 py-3 font-medium rounded-md shadow-sm lg:text-lg">
          Login
        </button>
      </div>
    </main>
